...
router.register(r'^bounty/(?P<bounty_id>\d+)/fulfillment/(?P<fulfillment_id>\d+)/comment', views.FulfillmentComments, 'fulfillment_comments')
...
urlpatterns = [
    ...
    url(r'^fulfillment/(?P<fulfillment_id>\d+)/review/$', views.FulfillmentReviews.as_view()),
