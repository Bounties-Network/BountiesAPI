...
Install hasura cli, script in `./graphql/install-hasura-cli.sh`
...
Visit the [production](https://api.bounties.network/) or rinkeby [endpoint](https://rinkeby.api.bounties.network/). Both default to the swagger documentation ui. The local version also serves the documentation.
