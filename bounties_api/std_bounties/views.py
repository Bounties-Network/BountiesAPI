...
from std_bounties.filters import BountiesFilter, FulfillmentsFilter, RankedCategoryFilter, ReviewsFilter
...
class SubmissionReviews(APIView):
    ...
    def post(self, request, bounty_id, fulfillment_id):
        ...
        notification_client.rating_issued(
            bounty.bounty_id, review, fulfillment.id, reviewer, reviewee)
