...
from user.permissions import AuthenticationPermission, BountyStatePermissions
from std_bounties.models import FulfillerApplication
from std_bounties.serializers import BountyStateSerializer
from notifications.notification_client import NotificationClient
notification_client = NotificationClient()


class BountyStateView(GenericAPIView, UpdateModelMixin):
    serializer_class = BountyStateSerializer
